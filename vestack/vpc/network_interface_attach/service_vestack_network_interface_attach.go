...
type VestackNetworkInterfaceAttachService struct {
	Client *bp.SdkClient
}

func NewNetworkInterfaceAttachService(c *bp.SdkClient) *VestackNetworkInterfaceAttachService {
	return &VestackNetworkInterfaceAttachService{
		Client: c,
	}
}

func (s *VestackNetworkInterfaceAttachService) GetClient() *bp.SdkClient {
	return s.Client
}

func (s *VestackNetworkInterfaceAttachService) ReadResources(condition map[string]interface{}) (data []interface{}, err error) {
	return nil, nil
}

func (s *VestackNetworkInterfaceAttachService) ReadResource(resourceData *schema.ResourceData, id string) (data map[string]interface{}, err error) {
	var (
...
func (s *VestackNetworkInterfaceAttachService) RefreshResourceState(resourceData *schema.ResourceData, target []string, timeout time.Duration, id string) *resource.StateChangeConf {
...
func (VestackNetworkInterfaceAttachService) WithResourceResponseHandlers(networkInterface map[string]interface{}) []bp.ResourceResponseHandler {
...
func (s *VestackNetworkInterfaceAttachService) CreateResource(resourceData *schema.ResourceData, resource *schema.Resource) []bp.Callback {
...
func (s *VestackNetworkInterfaceAttachService) ModifyResource(resourceData *schema.ResourceData, resource *schema.Resource) []bp.Callback {
	return []bp.Callback{}
}

func (s *VestackNetworkInterfaceAttachService) RemoveResource(resourceData *schema.ResourceData, r *schema.Resource) []bp.Callback {
...
func (s *VestackNetworkInterfaceAttachService) DatasourceResources(*schema.ResourceData, *schema.Resource) bp.DataSourceInfo {
