...
func DataSourceVestackNetworkAcls() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceVestackNetworkAclsRead,
...
func dataSourceVestackNetworkAclsRead(d *schema.ResourceData, meta interface{}) error {
	aclService := NewNetworkAclService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(aclService, d, DataSourceVestackNetworkAcls())
}
