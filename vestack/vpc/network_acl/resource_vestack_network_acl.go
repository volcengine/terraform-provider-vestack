...
func ResourceVestackNetworkAcl() *schema.Resource {
	return &schema.Resource{
		Create: resourceVestackNetworkAclCreate,
		Read:   resourceVestackNetworkAclRead,
		Update: resourceVestackNetworkAclUpdate,
		Delete: resourceVestackNetworkAclDelete,
...
func resourceVestackNetworkAclCreate(d *schema.ResourceData, meta interface{}) (err error) {
	aclService := NewNetworkAclService(meta.(*bp.SdkClient))
	err = bp.DefaultDispatcher().Create(aclService, d, ResourceVestackNetworkAcl())
	if err != nil {
		return fmt.Errorf("error on creating network acl %q, %w", d.Id(), err)
	}
	return resourceVestackNetworkAclRead(d, meta)
}

func resourceVestackNetworkAclRead(d *schema.ResourceData, meta interface{}) (err error) {
	aclService := NewNetworkAclService(meta.(*bp.SdkClient))
	err = bp.DefaultDispatcher().Read(aclService, d, ResourceVestackNetworkAcl())
	if err != nil {
...
func resourceVestackNetworkAclUpdate(d *schema.ResourceData, meta interface{}) (err error) {
	aclService := NewNetworkAclService(meta.(*bp.SdkClient))
	err = bp.DefaultDispatcher().Update(aclService, d, ResourceVestackNetworkAcl())
	if err != nil {
...
func resourceVestackNetworkAclDelete(d *schema.ResourceData, meta interface{}) (err error) {
	aclService := NewNetworkAclService(meta.(*bp.SdkClient))
	err = bp.DefaultDispatcher().Delete(aclService, d, ResourceVestackNetworkAcl())
	if err != nil {
