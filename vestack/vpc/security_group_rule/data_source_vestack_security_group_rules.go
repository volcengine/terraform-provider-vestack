...
func DataSourceVestackSecurityGroupRules() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceVestackSecurityGroupRulesRead,
...
func dataSourceVestackSecurityGroupRulesRead(d *schema.ResourceData, meta interface{}) error {
	securityGroupService := NewSecurityGroupRuleService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(securityGroupService, d, DataSourceVestackSecurityGroupRules())
}
