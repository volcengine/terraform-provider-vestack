...
func DataSourceVestackRouteEntries() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceVestackRouteEntriesRead,
...
func dataSourceVestackRouteEntriesRead(d *schema.ResourceData, meta interface{}) error {
	routeEntryService := NewRouteEntryService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(routeEntryService, d, DataSourceVestackRouteEntries())
}
