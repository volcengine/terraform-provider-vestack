...
func NewTrafficMirrorSessionService(c *ve.SdkClient) *VestackTrafficMirrorSessionService {
...
func (s *VestackTrafficMirrorSessionService) GetClient() *ve.SdkClient {
	return s.Client
}
...
func (VestackTrafficMirrorSessionService) WithResourceResponseHandlers(d map[string]interface{}) []ve.ResourceResponseHandler {
...
func (s *VestackTrafficMirrorSessionService) CreateResource(resourceData *schema.ResourceData, resource *schema.Resource) []ve.Callback {
...
func (s *VestackTrafficMirrorSessionService) ModifyResource(resourceData *schema.ResourceData, resource *schema.Resource) []ve.Callback {
...
func (s *VestackTrafficMirrorSessionService) RemoveResource(resourceData *schema.ResourceData, r *schema.Resource) []ve.Callback {
	callback := ve.Callback{
		Call: ve.SdkCall{
...
func (s *VestackTrafficMirrorSessionService) DatasourceResources(*schema.ResourceData, *schema.Resource) ve.DataSourceInfo {
...
func (s *VestackTrafficMirrorSessionService) ProjectTrn() *ve.ProjectTrn {
