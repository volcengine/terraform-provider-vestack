...
func ResourceVestackTrafficMirrorSession() *schema.Resource {
	resource := &schema.Resource{
		Create: resourceVestackTrafficMirrorSessionCreate,
		Read:   resourceVestackTrafficMirrorSessionRead,
		Update: resourceVestackTrafficMirrorSessionUpdate,
		Delete: resourceVestackTrafficMirrorSessionDelete,
...
func resourceVestackTrafficMirrorSessionCreate(d *schema.ResourceData, meta interface{}) (err error) {
	...
	return resourceVestackTrafficMirrorSessionRead(d, meta)
}
