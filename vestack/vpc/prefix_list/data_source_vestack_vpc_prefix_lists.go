...
func DataSourceVestackVpcPrefixLists() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceVestackVpcPrefixListsRead,
...
func dataSourceVestackVpcPrefixListsRead(d *schema.ResourceData, meta interface{}) error {
	service := NewVpcPrefixListService(meta.(*bp.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceVestackVpcPrefixLists())
}
