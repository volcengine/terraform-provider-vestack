...
func DataSourceVestackIpv6Gateways() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceVestackIpv6GatewaysRead,
...
func dataSourceVestackIpv6GatewaysRead(d *schema.ResourceData, meta interface{}) error {
	ipv6GatewayService := NewIpv6GatewayService(meta.(*bp.SdkClient))
	return ipv6GatewayService.Dispatcher.Data(ipv6GatewayService, d, DataSourceVestackIpv6Gateways())
}
