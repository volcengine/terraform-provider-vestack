...
func DataSourceVestackIpv6AddressBandwidths() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceVestackIpv6AddressBandwidthsRead,
...
func dataSourceVestackIpv6AddressBandwidthsRead(d *schema.ResourceData, meta interface{}) error {
	ipv6AddressBandwidthService := NewIpv6AddressBandwidthService(meta.(*bp.SdkClient))
	return ipv6AddressBandwidthService.Dispatcher.Data(ipv6AddressBandwidthService, d, DataSourceVestackIpv6AddressBandwidths())
}
