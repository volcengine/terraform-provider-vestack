...
func DataSourceVestackVpcs() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceVestackVpcsRead,
...
func dataSourceVestackVpcsRead(d *schema.ResourceData, meta interface{}) error {
	vpcService := NewVpcService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(vpcService, d, DataSourceVestackVpcs())
}
