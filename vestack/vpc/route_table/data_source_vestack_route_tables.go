...
func DataSourceVestackRouteTables() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceVestackRouteTablesRead,
...
func dataSourceVestackRouteTablesRead(d *schema.ResourceData, meta interface{}) error {
	routeTableService := NewRouteTableService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(routeTableService, d, DataSourceVestackRouteTables())
}
