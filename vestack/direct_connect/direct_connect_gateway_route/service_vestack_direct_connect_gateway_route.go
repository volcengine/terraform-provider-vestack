...
func (s *VestackDirectConnectGatewayRouteService) ReadResources(m map[string]interface{}) (data []interface{}, err error) {
	var (
...
func (s *VestackDirectConnectGatewayRouteService) ReadResource(resourceData *schema.ResourceData, id string) (data map[string]interface{}, err error) {
	var (
		results []interface{}
		ok      bool
	)
...
func (s *VestackDirectConnectGatewayRouteService) RefreshResourceState(resourceData *schema.ResourceData, target []string, timeout time.Duration, id string) *resource.StateChangeConf {
...
func (s *VestackDirectConnectGatewayRouteService) ReadResourceId(id string) string {
	return id
}
