...
func (s *VestackDirectConnectBgpPeerService) ReadResources(m map[string]interface{}) (data []interface{}, err error) {
	var (
...
func (s *VestackDirectConnectBgpPeerService) ReadResource(resourceData *schema.ResourceData, id string) (data map[string]interface{}, err error) {
	var (
		results []interface{}
		ok      bool
	)
...
func (s *VestackDirectConnectBgpPeerService) RefreshResourceState(resourceData *schema.ResourceData, target []string, timeout time.Duration, id string) *resource.StateChangeConf {
...
func (s *VestackDirectConnectBgpPeerService) ReadResourceId(id string) string {
	return id
}
