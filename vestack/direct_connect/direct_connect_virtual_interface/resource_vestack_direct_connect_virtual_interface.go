...
func ResourceVestackDirectConnectVirtualInterface() *schema.Resource {
	resource := &schema.Resource{
		Create: resourceVestackDirectConnectVirtualInterfaceCreate,
		Read:   resourceVestackDirectConnectVirtualInterfaceRead,
		Update: resourceVestackDirectConnectVirtualInterfaceUpdate,
		Delete: resourceVestackDirectConnectVirtualInterfaceDelete,
...
func resourceVestackDirectConnectVirtualInterfaceCreate(d *schema.ResourceData, meta interface{}) (err error) {
	...
	return resourceVestackDirectConnectVirtualInterfaceRead(d, meta)
}
