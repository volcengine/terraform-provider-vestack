...
func DataSourceVestackListeners() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceVestackListenersRead,
...
func dataSourceVestackListenersRead(d *schema.ResourceData, meta interface{}) error {
	listenerService := NewListenerService(meta.(*ve.SdkClient))
	return ve.DefaultDispatcher().Data(listenerService, d, DataSourceVestackListeners())
}
