...
const testAccVestackClbRulesDatasourceConfig = `
...
data "vestack_clb_rules" "foo"{
    ids = ["${vestack_clb_rule.foo.id}"]
    listener_id = "${vestack_listener.foo.id}"
}
`

func TestAccVestackClbRulesDatasource_Basic(t *testing.T) {
	resourceName := "data.vestack_clb_rules.foo"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccVestackClbRulesDatasourceConfig,
