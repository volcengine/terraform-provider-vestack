...
func DataSourceVestackListenerHealths() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceVestackListenerHealthsRead,
...
func dataSourceVestackListenerHealthsRead(d *schema.ResourceData, meta interface{}) error {
	service := NewListenerHealthService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(service, d, DataSourceVestackListenerHealths())
}
