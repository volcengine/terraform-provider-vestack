...
func (s *VestackAclEntryService) ReadResources(condition map[string]interface{}) ([]interface{}, error) {
	var (
...
func (s *VestackAclEntryService) ReadResource(resourceData *schema.ResourceData, tmpId string) (map[string]interface{}, error) {
	if tmpId == "" {
...
func (s *VestackAclEntryService) RefreshResourceState(resourceData *schema.ResourceData, target []string, timeout time.Duration, id string) *resource.StateChangeConf {
	return nil
}
