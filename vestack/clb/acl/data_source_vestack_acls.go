...
func DataSourceVestackAcls() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceVestackAclsRead,
...
func dataSourceVestackAclsRead(d *schema.ResourceData, meta interface{}) error {
	aclService := NewAclService(meta.(*ve.SdkClient))
	return ve.DefaultDispatcher().Data(aclService, d, DataSourceVestackAcls())
}
