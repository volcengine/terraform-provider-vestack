...
func DataSourceVestackEcsLaunchTemplates() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceVestackEcsLaunchTemplatesRead,
			...
			"launch_templates": {
				...
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						...
						"launch_template_tags": bp.TagsSchemaComputed(),
						"version_description": {
							Type:        schema.TypeString,
							Computed:    true,
...
func dataSourceVestackEcsLaunchTemplatesRead(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewEcsLaunchTemplateService(meta.(*bp.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceVestackEcsLaunchTemplates())
}
