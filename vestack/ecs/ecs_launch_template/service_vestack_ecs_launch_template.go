...
func (s *VestackEcsLaunchTemplateService) ProjectTrn() *bp.ProjectTrn {
...
func setLaunchTemplateTags(serviceClient *bp.SdkClient, addAction, removeAction, resourceType string,
	resourceData *schema.ResourceData, getUniversalInfo bp.GetUniversalInfo) []bp.Callback {
	var callbacks []bp.Callback
	addedTags, removedTags, _, _ := bp.GetSetDifference("launch_template_tags", resourceData, LaunchTemplateTagsHash, false)
