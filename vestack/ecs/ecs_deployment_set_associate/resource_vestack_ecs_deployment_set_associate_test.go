...
const testAccVestackEcsDeploymentSetAssociateCreateConfig = `
...
func TestAccVestackEcsDeploymentSetAssociateResource_Basic(t *testing.T) {
	resourceName := "vestack_ecs_deployment_set_associate.foo"

	acc := &vestack.AccTestResource{
		ResourceId: resourceName,
		Svc:        &ecs_deployment_set_associate.VestackEcsDeploymentSetAssociateService{},
	}
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccVestackEcsDeploymentSetAssociateCreateConfig,
