...
func DataSourceVestackEcsCommands() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceVestackEcsCommandsRead,
...
func dataSourceVestackEcsCommandsRead(d *schema.ResourceData, meta interface{}) error {
	service := NewEcsCommandService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(service, d, DataSourceVestackEcsCommands())
}
