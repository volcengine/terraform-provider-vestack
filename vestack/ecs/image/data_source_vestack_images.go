...
func DataSourceVestackImages() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceVestackImagesRead,
...
func dataSourceVestackImagesRead(d *schema.ResourceData, meta interface{}) error {
	imageService := NewImageService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(imageService, d, DataSourceVestackImages())
}
