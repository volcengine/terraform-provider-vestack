...
func DataSourceVestackEcsDeploymentSets() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceVestackEcsDeploymentSetsRead,
...
func dataSourceVestackEcsDeploymentSetsRead(d *schema.ResourceData, meta interface{}) error {
	deploymentSetService := NewEcsDeploymentSetService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(deploymentSetService, d, DataSourceVestackEcsDeploymentSets())
}
