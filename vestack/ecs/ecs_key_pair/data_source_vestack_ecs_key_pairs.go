...
func DataSourceVestackEcsKeyPairs() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceVestackEcsKeyPairsRead,
...
func dataSourceVestackEcsKeyPairsRead(d *schema.ResourceData, meta interface{}) error {
	service := NewEcsKeyPairService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(service, d, DataSourceVestackEcsKeyPairs())
}
