...
func DataSourceVestackEcsInvocationResults() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceVestackEcsInvocationResultsRead,
...
func dataSourceVestackEcsInvocationResultsRead(d *schema.ResourceData, meta interface{}) error {
	service := NewEcsInvocationResultService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(service, d, DataSourceVestackEcsInvocationResults())
}
