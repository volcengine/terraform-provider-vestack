...
func DataSourceVestackEcsInvocations() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceVestackEcsInvocationsRead,
...
func dataSourceVestackEcsInvocationsRead(d *schema.ResourceData, meta interface{}) error {
	service := NewEcsInvocationService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(service, d, DataSourceVestackEcsInvocations())
}
