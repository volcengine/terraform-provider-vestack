...
const testAccVestackSnatEntriesDatasourceConfig = `
...
func TestAccVestackSnatEntriesDatasource_Basic(t *testing.T) {
	resourceName := "data.vestack_snat_entries.foo"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccVestackSnatEntriesDatasourceConfig,
