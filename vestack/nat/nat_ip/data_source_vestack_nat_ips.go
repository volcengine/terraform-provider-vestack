...
func DataSourceVestackNatIps() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceVestackNatIpsRead,
...
func dataSourceVestackNatIpsRead(d *schema.ResourceData, meta interface{}) error {
	service := NewNatIpService(meta.(*bp.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceVestackNatIps())
}
