...
func resourceVestackEipAddressCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if err := bp.DefaultDispatcher().Create(eipAddressService, d, ResourceVestackEipAddress()); err != nil {
...
func resourceVestackEipAddressRead(d *schema.ResourceData, meta interface{}) error {
	eipAddressService := NewEipAddressService(meta.(*bp.SdkClient))
	if err := bp.DefaultDispatcher().Read(eipAddressService, d, ResourceVestackEipAddress()); err != nil {
...
func resourceVestackEipAddressUpdate(d *schema.ResourceData, meta interface{}) error {
	eipAddressService := NewEipAddressService(meta.(*bp.SdkClient))
	if err := bp.DefaultDispatcher().Update(eipAddressService, d, ResourceVestackEipAddress()); err != nil {
...
func resourceVestackEipAddressDelete(d *schema.ResourceData, meta interface{}) error {
	eipAddressService := NewEipAddressService(meta.(*bp.SdkClient))
	if err := bp.DefaultDispatcher().Delete(eipAddressService, d, ResourceVestackEipAddress()); err != nil {
