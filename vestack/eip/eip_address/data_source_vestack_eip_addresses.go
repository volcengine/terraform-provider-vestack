...
func DataSourceVestackEipAddresses() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceVestackEipAddressesRead,
...
func dataSourceVestackEipAddressesRead(d *schema.ResourceData, meta interface{}) error {
	eipAddressService := NewEipAddressService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(eipAddressService, d, DataSourceVestackEipAddresses())
}
