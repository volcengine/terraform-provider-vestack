...
func DataSourceVestackCrVpcEndpoints() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceVestackCrVpcEndpointsRead,
...
func dataSourceVestackCrVpcEndpointsRead(d *schema.ResourceData, meta interface{}) error {
	service := NewCrVpcEndpointService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(service, d, DataSourceVestackCrVpcEndpoints())
}
