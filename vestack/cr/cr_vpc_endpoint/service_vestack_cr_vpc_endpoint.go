...
type VestackCrVpcEndpointService struct {
	Client *bp.SdkClient
}

func (v *VestackCrVpcEndpointService) GetClient() *bp.SdkClient {
	return v.Client
}

func (v *VestackCrVpcEndpointService) ReadResources(condition map[string]interface{}) (data []interface{}, err error) {
	var (
...
func (v *VestackCrVpcEndpointService) ReadResource(resourceData *schema.ResourceData, id string) (data map[string]interface{}, err error) {
	var (
		results []interface{}
		ok      bool
	)
...
func (v *VestackCrVpcEndpointService) RefreshResourceState(resourceData *schema.ResourceData, target []string, timeout time.Duration, id string) *resource.StateChangeConf {
	return &resource.StateChangeConf{}
}

func (v *VestackCrVpcEndpointService) WithResourceResponseHandlers(m map[string]interface{}) []bp.ResourceResponseHandler {
...
func (v *VestackCrVpcEndpointService) CreateResource(data *schema.ResourceData, resource *schema.Resource) []bp.Callback {
...
func (v *VestackCrVpcEndpointService) ModifyResource(data *schema.ResourceData, resource *schema.Resource) []bp.Callback {
	callback := bp.Callback{
		Call: bp.SdkCall{
			Action:      "UpdateVpcEndpoint",
			ContentType: bp.ContentTypeJson,
...
func (v *VestackCrVpcEndpointService) RemoveResource(data *schema.ResourceData, resource *schema.Resource) []bp.Callback {
	callback := bp.Callback{
		Call: bp.SdkCall{
			Action:      "UpdateVpcEndpoint",
			ContentType: bp.ContentTypeJson,
...
func (v *VestackCrVpcEndpointService) DatasourceResources(data *schema.ResourceData, resource *schema.Resource) bp.DataSourceInfo {
...
func (v *VestackCrVpcEndpointService) ReadResourceId(id string) string {
	return id
}

func NewCrVpcEndpointService(c *bp.SdkClient) *VestackCrVpcEndpointService {
	return &VestackCrVpcEndpointService{
		Client: c,
	}
}

func (v *VestackCrVpcEndpointService) RefreshVpcStatus() bp.CallFunc {
...
func (v *VestackCrVpcEndpointService) checkVpcStatus(d *schema.ResourceData) error {
...
func (v *VestackCrVpcEndpointService) integrateVpcParams(d *schema.ResourceData, call bp.SdkCall) (*map[string]interface{}, error) {
	var (
