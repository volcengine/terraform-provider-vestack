...
func DataSourceVestackCrNamespaces() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceVestackCrNamespacesRead,
...
func dataSourceVestackCrNamespacesRead(d *schema.ResourceData, meta interface{}) error {
	service := NewCrNamespaceService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(service, d, DataSourceVestackCrNamespaces())
}
