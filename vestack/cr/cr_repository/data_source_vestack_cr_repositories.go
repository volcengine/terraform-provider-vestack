...
func DataSourceVestackCrRepositories() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceVestackCrRepositoriesRead,
...
func dataSourceVestackCrRepositoriesRead(d *schema.ResourceData, meta interface{}) error {
	service := NewCrRepositoryService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(service, d, DataSourceVestackCrRepositories())
}
