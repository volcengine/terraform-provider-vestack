...
func DataSourceVestackCrTags() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceVestackCrTagsRead,
...
func dataSourceVestackCrTagsRead(d *schema.ResourceData, meta interface{}) error {
	service := NewCrTagService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(service, d, DataSourceVestackCrTags())
}
