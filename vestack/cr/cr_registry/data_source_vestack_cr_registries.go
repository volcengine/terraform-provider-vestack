...
func DataSourceVestackCrRegistries() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceVestackCrRegistriesRead,
...
func dataSourceVestackCrRegistriesRead(d *schema.ResourceData, meta interface{}) error {
	service := NewCrRegistryService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(service, d, DataSourceVestackCrRegistries())
}
