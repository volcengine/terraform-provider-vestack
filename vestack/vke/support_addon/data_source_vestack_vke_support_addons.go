...
func DataSourceVestackVkeVkeSupportedAddons() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceVestackVkeSupportAddonsRead,
...
func dataSourceVestackVkeSupportAddonsRead(d *schema.ResourceData, meta interface{}) error {
	service := NewVkeSupportAddonService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(service, d, DataSourceVestackVkeVkeSupportedAddons())
}
