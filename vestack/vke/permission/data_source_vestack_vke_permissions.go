...
func DataSourceVestackVkePermissions() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceVestackVkePermissionsRead,
...
func dataSourceVestackVkePermissionsRead(d *schema.ResourceData, meta interface{}) error {
	service := NewVkePermissionService(meta.(*bp.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceVestackVkePermissions())
}
