...
const testAccVestackVkeNodesDatasourceConfig = `
...
func TestAccVestackVkeNodesDatasource_Basic(t *testing.T) {
	resourceName := "data.vestack_vke_nodes.foo"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccVestackVkeNodesDatasourceConfig,
