...
const testAccVestackVkeNodePoolSystemVolumeAndDataVolumeConfig = `
...
// 修改系统盘（修改）和数据盘（修改&减少）
func TestAccVestackVkeNodePoolResource_VolumeUpdate(t *testing.T) {
	resourceName := "vestack_vke_node_pool.foo"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccVestackVkeNodePoolSystemVolumeAndDataVolumeConfig,
				Check: resource.ComposeTestCheckFunc(
					vestack.AccTestCheckResourceExists(acc),
					resource.TestCheckResourceAttr(acc.ResourceId, "name", "acc-test-node-pool"),
					resource.TestCheckResourceAttr(acc.ResourceId, "auto_scaling.#", "1"),
...
const testAccVestackVkeNodePoolDeleteDataVolumeConfig = `
...
// 清空数据盘
func TestAccVestackVkeNodePoolResource_ClearVolumeUpdate(t *testing.T) {
	resourceName := "vestack_vke_node_pool.foo"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccVestackVkeNodePoolDeleteDataVolumeConfig,
				Check: resource.ComposeTestCheckFunc(
					vestack.AccTestCheckResourceExists(acc),
					resource.TestCheckResourceAttr(acc.ResourceId, "name", "acc-test-node-pool"),
					resource.TestCheckResourceAttr(acc.ResourceId, "auto_scaling.#", "1"),
