...
const testAccVestackVkeNodePoolsDatasourceConfig = `
...
data "vestack_vke_node_pools" "foo"{
    ids = vestack_vke_node_pool.foo[*].id
}
`

func TestAccVestackVkeNodePoolsDatasource_Basic(t *testing.T) {
	resourceName := "data.vestack_vke_node_pools.foo"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccVestackVkeNodePoolsDatasourceConfig,
