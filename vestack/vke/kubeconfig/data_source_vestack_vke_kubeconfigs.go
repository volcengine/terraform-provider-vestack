...
func DataSourceVestackVkeKubeconfigs() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceVestackVkeKubeconfigsRead,
...
func dataSourceVestackVkeKubeconfigsRead(d *schema.ResourceData, meta interface{}) (err error) {
	kubeconfigService := NewVkeKubeconfigService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(kubeconfigService, d, DataSourceVestackVkeKubeconfigs())
}
