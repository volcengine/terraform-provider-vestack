...
func DataSourceVestackVkeAddons() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceVestackVkeAddonsRead,
...
func dataSourceVestackVkeAddonsRead(d *schema.ResourceData, meta interface{}) error {
	service := NewVkeAddonService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(service, d, DataSourceVestackVkeAddons())
}
