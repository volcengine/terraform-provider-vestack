...
func DataSourceVestackVolumes() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceVestackVolumesRead,
...
func dataSourceVestackVolumesRead(d *schema.ResourceData, meta interface{}) error {
	volumeService := NewVolumeService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(volumeService, d, DataSourceVestackVolumes())
}
