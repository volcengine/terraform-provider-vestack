...
func resourceVestackVolumeCreate(d *schema.ResourceData, meta interface{}) (err error) {
	...
	err = bp.DefaultDispatcher().Create(volumeService, d, ResourceVestackVolume())
	if err != nil {
...
func resourceVestackVolumeRead(d *schema.ResourceData, meta interface{}) (err error) {
	volumeService := NewVolumeService(meta.(*bp.SdkClient))
	err = bp.DefaultDispatcher().Read(volumeService, d, ResourceVestackVolume())
	if err != nil {
...
func resourceVestackVolumeUpdate(d *schema.ResourceData, meta interface{}) (err error) {
	volumeService := NewVolumeService(meta.(*bp.SdkClient))
	err = bp.DefaultDispatcher().Update(volumeService, d, ResourceVestackVolume())
	if err != nil {
...
func resourceVestackVolumeDelete(d *schema.ResourceData, meta interface{}) (err error) {
	volumeService := NewVolumeService(meta.(*bp.SdkClient))
	err = bp.DefaultDispatcher().Delete(volumeService, d, ResourceVestackVolume())
	if err != nil {
