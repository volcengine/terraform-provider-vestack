		...
		Schema: map[string]*schema.Schema{
			...
			"delete_with_instance": {
				...
				Description: "Delete Volume with Attached Instance." +
					"It is not recommended to use this field. If used, please ensure that the value of this field is consistent with the value of `delete_with_instance` in vestack_volume.",
			},
			"status": {
				Type:        schema.TypeString,
				Computed:    true,
...
func resourceVestackVolumeAttachCreate(d *schema.ResourceData, meta interface{}) (err error) {
	...
	err = bp.DefaultDispatcher().Create(volumeAttachService, d, ResourceVestackVolumeAttach())
	if err != nil {
...
func resourceVestackVolumeAttachRead(d *schema.ResourceData, meta interface{}) (err error) {
	volumeAttachService := NewVolumeAttachService(meta.(*bp.SdkClient))
	err = bp.DefaultDispatcher().Read(volumeAttachService, d, ResourceVestackVolumeAttach())
	if err != nil {
...
func resourceVestackVolumeAttachDelete(d *schema.ResourceData, meta interface{}) (err error) {
	volumeAttachService := NewVolumeAttachService(meta.(*bp.SdkClient))
	err = bp.DefaultDispatcher().Delete(volumeAttachService, d, ResourceVestackVolumeAttach())
	if err != nil {
