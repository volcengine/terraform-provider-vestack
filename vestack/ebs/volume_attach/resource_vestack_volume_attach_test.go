...
const testAccVestackVolumeAttachCreateConfig = `
...
func TestAccVestackVolumeAttachResource_Basic(t *testing.T) {
	resourceName := "vestack_volume_attach.foo"

	acc := &vestack.AccTestResource{
		ResourceId: resourceName,
		Svc:        &volume_attach.VestackVolumeAttachService{},
	}
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccVestackVolumeAttachCreateConfig,
...
const testAccVestackVolumeAttachDeleteWithInstanceConfig = `
data "vestack_zones" "foo"{
}
...
func TestAccVestackVolumeAttachResource_DeleteWithInstance(t *testing.T) {
	resourceName := "vestack_volume_attach.foo"
