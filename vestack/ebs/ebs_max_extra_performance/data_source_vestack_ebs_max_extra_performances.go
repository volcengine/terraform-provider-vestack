...
func DataSourceVestackEbsMaxExtraPerformances() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceVestackEbsMaxExtraPerformancesRead,
...
func dataSourceVestackEbsMaxExtraPerformancesRead(d *schema.ResourceData, meta interface{}) error {
	service := NewEbsMaxExtraPerformanceService(meta.(*bp.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceVestackEbsMaxExtraPerformances())
}
