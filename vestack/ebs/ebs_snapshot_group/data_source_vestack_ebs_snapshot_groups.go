...
func DataSourceVestackEbsSnapshotGroups() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceVestackEbsSnapshotGroupsRead,
...
func dataSourceVestackEbsSnapshotGroupsRead(d *schema.ResourceData, meta interface{}) error {
	service := NewEbsSnapshotGroupService(meta.(*bp.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceVestackEbsSnapshotGroups())
}
