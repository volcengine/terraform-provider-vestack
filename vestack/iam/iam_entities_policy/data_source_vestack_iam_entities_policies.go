...
func DataSourceVestackIamEntitiesPolicies() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceVestackIamEntitiesPoliciesRead,
...
func dataSourceVestackIamEntitiesPoliciesRead(d *schema.ResourceData, meta interface{}) error {
	service := NewIamEntitiesPolicyService(meta.(*bp.SdkClient))
