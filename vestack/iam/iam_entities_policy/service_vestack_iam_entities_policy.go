...
type VestackIamEntitiesPolicyService struct {
	Client *bp.SdkClient
}

func NewIamEntitiesPolicyService(c *bp.SdkClient) *VestackIamEntitiesPolicyService {
	return &VestackIamEntitiesPolicyService{
		Client: c,
	}
}

func (s *VestackIamEntitiesPolicyService) GetClient() *bp.SdkClient {
	return s.Client
}

func (s *VestackIamEntitiesPolicyService) ReadResources(m map[string]interface{}) (data []interface{}, err error) {
	...
	users, err := bp.ObtainSdkValue("Result.PolicyUsers", *resp)
	if err != nil {
		return data, err
	}
	...
	roles, err := bp.ObtainSdkValue("Result.PolicyRoles", *resp)
	if err != nil {
		return data, err
	}
	...
	userGroups, err := bp.ObtainSdkValue("Result.PolicyUserGroups", *resp)
	if err != nil {
		return data, err
	}
	...
	total, err := bp.ObtainSdkValue("Result.Total", *resp)
	if err != nil {
		return data, err
	}
	if total == nil {
...
func (s *VestackIamEntitiesPolicyService) ReadResource(resourceData *schema.ResourceData, id string) (data map[string]interface{}, err error) {
	return nil, errors.New("not support")
}

func (s *VestackIamEntitiesPolicyService) RefreshResourceState(data *schema.ResourceData, strings []string, duration time.Duration, id string) *resource.StateChangeConf {
	return nil
}

func (s *VestackIamEntitiesPolicyService) WithResourceResponseHandlers(d map[string]interface{}) []bp.ResourceResponseHandler {
	return nil
}

func (s *VestackIamEntitiesPolicyService) CreateResource(data *schema.ResourceData, resource *schema.Resource) []bp.Callback {
	return nil
}

func (s *VestackIamEntitiesPolicyService) ModifyResource(data *schema.ResourceData, resource *schema.Resource) []bp.Callback {
	return nil
}

func (s *VestackIamEntitiesPolicyService) RemoveResource(data *schema.ResourceData, r *schema.Resource) []bp.Callback {
	return nil
}

func (s *VestackIamEntitiesPolicyService) DatasourceResources(data *schema.ResourceData, resource *schema.Resource) bp.DataSourceInfo {
...
func (s *VestackIamEntitiesPolicyService) ReadResourceId(id string) string {
	return id
}
