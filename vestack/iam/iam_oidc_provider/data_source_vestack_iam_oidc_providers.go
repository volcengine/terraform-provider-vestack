...
func DataSourceVestackIamOidcProviders() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceVestackIamOidcProvidersRead,
...
func dataSourceVestackIamOidcProvidersRead(d *schema.ResourceData, meta interface{}) error {
	service := NewIamOidcProviderService(meta.(*bp.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceVestackIamOidcProviders())
}
