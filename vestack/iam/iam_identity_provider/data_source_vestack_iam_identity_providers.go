...
func DataSourceVestackIamIdentityProviders() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceVestackIamIdentityProvidersRead,
...
func dataSourceVestackIamIdentityProvidersRead(d *schema.ResourceData, meta interface{}) error {
	service := NewIamIdentityProviderService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(service, d, DataSourceVestackIamIdentityProviders())
}
