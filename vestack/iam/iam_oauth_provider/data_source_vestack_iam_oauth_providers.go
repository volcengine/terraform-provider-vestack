...
func DataSourceVestackIamOAuthProviders() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceVestackIamOAuthProvidersRead,
...
func dataSourceVestackIamOAuthProvidersRead(d *schema.ResourceData, meta interface{}) error {
	service := NewIamOAuthProviderService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(service, d, DataSourceVestackIamOAuthProviders())
}
