...
func DataSourceVestackIamUsers() *schema.Resource {
...
func dataSourceVestackIamUsersRead(d *schema.ResourceData, meta interface{}) error {
	eipAddressService := NewIamUserService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(eipAddressService, d, DataSourceVestackIamUsers())
}
