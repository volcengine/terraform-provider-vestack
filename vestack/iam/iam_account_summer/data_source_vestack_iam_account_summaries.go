...
func DataSourceVestackIamAccountSummaries() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceVestackIamAccountSummariesRead,
...
func dataSourceVestackIamAccountSummariesRead(d *schema.ResourceData, meta interface{}) error {
	service := NewIamAccountSummaryService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(service, d, DataSourceVestackIamAccountSummaries())
}
