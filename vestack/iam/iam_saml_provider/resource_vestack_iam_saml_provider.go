...
```
$ terraform import vestack_iam_saml_provider.default SAMLProviderName
```

*/

func ResourceVestackIamSamlProvider() *schema.Resource {
	resource := &schema.Resource{
		Create: resourceVestackIamSamlProviderCreate,
		Read:   resourceVestackIamSamlProviderRead,
		Update: resourceVestackIamSamlProviderUpdate,
		Delete: resourceVestackIamSamlProviderDelete,
...
func resourceVestackIamSamlProviderCreate(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewIamSamlProviderService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Create(service, d, ResourceVestackIamSamlProvider())
	if err != nil {
		return fmt.Errorf("error on creating iam_saml_provider %q, %s", d.Id(), err)
	}
	return resourceVestackIamSamlProviderRead(d, meta)
}

func resourceVestackIamSamlProviderRead(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewIamSamlProviderService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Read(service, d, ResourceVestackIamSamlProvider())
	if err != nil {
...
func resourceVestackIamSamlProviderUpdate(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewIamSamlProviderService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Update(service, d, ResourceVestackIamSamlProvider())
	if err != nil {
...
func resourceVestackIamSamlProviderDelete(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewIamSamlProviderService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Delete(service, d, ResourceVestackIamSamlProvider())
	if err != nil {
