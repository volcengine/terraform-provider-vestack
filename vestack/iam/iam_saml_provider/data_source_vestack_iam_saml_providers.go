...
func DataSourceVestackIamSamlProviders() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceVestackIamSamlProvidersRead,
...
func dataSourceVestackIamSamlProvidersRead(d *schema.ResourceData, meta interface{}) error {
	service := NewIamSamlProviderService(meta.(*bp.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceVestackIamSamlProviders())
}
