...
func DataSourceVestackIamLoginProfiles() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceVestackIamLoginProfilesRead,
...
func dataSourceVestackIamLoginProfilesRead(d *schema.ResourceData, meta interface{}) error {
	service := NewIamLoginProfileService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(service, d, DataSourceVestackIamLoginProfiles())
}
