...
func DataSourceVestackTosObjects() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceVestackTosObjectRead,
...
func dataSourceVestackTosObjectRead(d *schema.ResourceData, meta interface{}) error {
	tosBucketService := NewTosObjectService(meta.(*bp.SdkClient))
	return bp.DefaultDispatcher().Data(tosBucketService, d, DataSourceVestackTosObjects())
}
