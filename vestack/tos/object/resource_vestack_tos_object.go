...
func resourceVestackTosObjectCreate(d *schema.ResourceData, meta interface{}) (err error) {
	...
	err = bp.DefaultDispatcher().Create(tosBucketService, d, ResourceVestackTosObject())
	if err != nil {
...
func resourceVestackTosObjectRead(d *schema.ResourceData, meta interface{}) (err error) {
	tosBucketService := NewTosObjectService(meta.(*bp.SdkClient))
	err = bp.DefaultDispatcher().Read(tosBucketService, d, ResourceVestackTosObject())
	if err != nil {
...
func resourceVestackTosObjectUpdate(d *schema.ResourceData, meta interface{}) (err error) {
	tosBucketService := NewTosObjectService(meta.(*bp.SdkClient))
	err = bp.DefaultDispatcher().Update(tosBucketService, d, ResourceVestackTosObject())
	if err != nil {
...
func resourceVestackTosObjectDelete(d *schema.ResourceData, meta interface{}) (err error) {
	tosBucketService := NewTosObjectService(meta.(*bp.SdkClient))
	err = bp.DefaultDispatcher().Delete(tosBucketService, d, ResourceVestackTosObject())
	if err != nil {
