...
func DataSourceVestackTosBucketInventories() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceVestackTosBucketInventoriesRead,
...
func dataSourceVestackTosBucketInventoriesRead(d *schema.ResourceData, meta interface{}) error {
	service := NewTosBucketInventoryService(meta.(*bp.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceVestackTosBucketInventories())
}
