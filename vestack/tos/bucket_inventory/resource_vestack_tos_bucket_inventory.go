...
```
$ terraform import vestack_tos_bucket_inventory.default resource_id
```

*/

func ResourceVestackTosBucketInventory() *schema.Resource {
	resource := &schema.Resource{
		Create: resourceVestackTosBucketInventoryCreate,
		Read:   resourceVestackTosBucketInventoryRead,
		Update: resourceVestackTosBucketInventoryUpdate,
		Delete: resourceVestackTosBucketInventoryDelete,
...
func resourceVestackTosBucketInventoryCreate(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewTosBucketInventoryService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Create(service, d, ResourceVestackTosBucketInventory())
	if err != nil {
		return fmt.Errorf("error on creating tos_bucket_inventory %q, %s", d.Id(), err)
	}
	return resourceVestackTosBucketInventoryRead(d, meta)
}

func resourceVestackTosBucketInventoryRead(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewTosBucketInventoryService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Read(service, d, ResourceVestackTosBucketInventory())
	if err != nil {
...
func resourceVestackTosBucketInventoryUpdate(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewTosBucketInventoryService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Update(service, d, ResourceVestackTosBucketInventory())
	if err != nil {
...
func resourceVestackTosBucketInventoryDelete(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewTosBucketInventoryService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Delete(service, d, ResourceVestackTosBucketInventory())
	if err != nil {
