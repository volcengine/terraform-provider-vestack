...
```
$ terraform import vestack_tos_bucket_replication.default bucket_name
```

*/

func ResourceVestackTosBucketReplication() *schema.Resource {
	resource := &schema.Resource{
		Create: resourceVestackTosBucketReplicationCreate,
		Read:   resourceVestackTosBucketReplicationRead,
		Update: resourceVestackTosBucketReplicationUpdate,
		Delete: resourceVestackTosBucketReplicationDelete,
...
func resourceVestackTosBucketReplicationCreate(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewTosBucketReplicationService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Create(service, d, ResourceVestackTosBucketReplication())
	if err != nil {
		return fmt.Errorf("error on creating tos_bucket_replication %q, %s", d.Id(), err)
	}
	return resourceVestackTosBucketReplicationRead(d, meta)
}

func resourceVestackTosBucketReplicationRead(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewTosBucketReplicationService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Read(service, d, ResourceVestackTosBucketReplication())
	if err != nil {
...
func resourceVestackTosBucketReplicationUpdate(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewTosBucketReplicationService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Update(service, d, ResourceVestackTosBucketReplication())
	if err != nil {
...
func resourceVestackTosBucketReplicationDelete(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewTosBucketReplicationService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Delete(service, d, ResourceVestackTosBucketReplication())
	if err != nil {
