...
```
$ terraform import vestack_tos_bucket_mirror_back.default bucket_name
```

*/

func ResourceVestackTosBucketMirrorBack() *schema.Resource {
	resource := &schema.Resource{
		Create: resourceVestackTosBucketMirrorBackCreate,
		Read:   resourceVestackTosBucketMirrorBackRead,
		Update: resourceVestackTosBucketMirrorBackUpdate,
		Delete: resourceVestackTosBucketMirrorBackDelete,
...
func resourceVestackTosBucketMirrorBackCreate(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewTosBucketMirrorBackService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Create(service, d, ResourceVestackTosBucketMirrorBack())
	if err != nil {
		return fmt.Errorf("error on creating tos_bucket_mirror_back %q, %s", d.Id(), err)
	}
	return resourceVestackTosBucketMirrorBackRead(d, meta)
}

func resourceVestackTosBucketMirrorBackRead(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewTosBucketMirrorBackService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Read(service, d, ResourceVestackTosBucketMirrorBack())
	if err != nil {
...
func resourceVestackTosBucketMirrorBackUpdate(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewTosBucketMirrorBackService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Update(service, d, ResourceVestackTosBucketMirrorBack())
	if err != nil {
...
func resourceVestackTosBucketMirrorBackDelete(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewTosBucketMirrorBackService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Delete(service, d, ResourceVestackTosBucketMirrorBack())
	if err != nil {
