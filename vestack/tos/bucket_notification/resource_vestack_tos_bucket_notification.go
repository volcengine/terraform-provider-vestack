...
```
$ terraform import vestack_tos_bucket_notification.default resource_id
```

*/

func ResourceVestackTosBucketNotification() *schema.Resource {
	resource := &schema.Resource{
		Create: resourceVestackTosBucketNotificationCreate,
		Read:   resourceVestackTosBucketNotificationRead,
		Update: resourceVestackTosBucketNotificationUpdate,
		Delete: resourceVestackTosBucketNotificationDelete,
...
func resourceVestackTosBucketNotificationCreate(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewTosBucketNotificationService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Create(service, d, ResourceVestackTosBucketNotification())
	if err != nil {
		return fmt.Errorf("error on creating tos_bucket_notification %q, %s", d.Id(), err)
	}
	return resourceVestackTosBucketNotificationRead(d, meta)
}

func resourceVestackTosBucketNotificationRead(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewTosBucketNotificationService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Read(service, d, ResourceVestackTosBucketNotification())
	if err != nil {
...
func resourceVestackTosBucketNotificationUpdate(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewTosBucketNotificationService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Update(service, d, ResourceVestackTosBucketNotification())
	if err != nil {
...
func resourceVestackTosBucketNotificationDelete(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewTosBucketNotificationService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Delete(service, d, ResourceVestackTosBucketNotification())
	if err != nil {
