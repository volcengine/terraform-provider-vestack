...
```
$ terraform import vestack_tos_bucket_lifecycle.default bucket_name
```

*/

func ResourceVestackTosBucketLifecycle() *schema.Resource {
	resource := &schema.Resource{
		Create: resourceVestackTosBucketLifecycleCreate,
		Read:   resourceVestackTosBucketLifecycleRead,
		Update: resourceVestackTosBucketLifecycleUpdate,
		Delete: resourceVestackTosBucketLifecycleDelete,
...
func resourceVestackTosBucketLifecycleCreate(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewTosBucketLifecycleService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Create(service, d, ResourceVestackTosBucketLifecycle())
	if err != nil {
		return fmt.Errorf("error on creating tos_bucket_lifecycle %q, %s", d.Id(), err)
	}
	return resourceVestackTosBucketLifecycleRead(d, meta)
}

func resourceVestackTosBucketLifecycleRead(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewTosBucketLifecycleService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Read(service, d, ResourceVestackTosBucketLifecycle())
	if err != nil {
...
func resourceVestackTosBucketLifecycleUpdate(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewTosBucketLifecycleService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Update(service, d, ResourceVestackTosBucketLifecycle())
	if err != nil {
...
func resourceVestackTosBucketLifecycleDelete(d *schema.ResourceData, meta interface{}) (err error) {
	service := NewTosBucketLifecycleService(meta.(*bp.SdkClient))
	err = service.Dispatcher.Delete(service, d, ResourceVestackTosBucketLifecycle())
	if err != nil {
